...
- Add a step for reviewing performance of the process
- Create an opportunity to investigate panel composition more deeply and explicitly
- Consider how this affects constraint choices
...
- Traits of interest (k) of 3 and 5
